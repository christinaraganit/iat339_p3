    ...
    <main className="project">
      ...
      <section>
        <div className="bg-neutral-900/60  rounded-2xl">
          ...
          <div className="p-6 lg:p-12 flex flex-col items-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-500/[9%] to-neutral-950/60 rounded-2xl">
      ...
      <section>
        ...
        <p className="mb-2">
          I surfaced the following findings that gave me an idea on how I could
          design such an app that could remain undetected.
        </p>
        <div className="grid lg:grid-cols-2 lg:gap-6">
          <div className="flex flex-col rounded-xl border border-neutral-800/60 bg-neutral-900/30 p-6">
            ...
            <p className="pb-0">
              ...
              violence reports increased following soccer matches whether the
              English national team lost <em>or</em> won.
            </p>
          </div>
          <div className="flex flex-col rounded-xl border border-neutral-800/60 bg-neutral-900/30 p-6">
            <h3 className="title-3">
            ...
            <p className="pb-0">
              I explored behaviours of sports fans, and discovered that ordering
              food seemed to be a typical part of watching sports, with food
              delivery service Deliveroo reporting a 25% increase in orders
              through their app before a big game.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-full">
        ...
        <p className="title-1 mb-4">
          Based on my findings, I made the decision that the app was to be
          disguised as a typical takeout mobile app, and I named it Chow Now.
        </p>
      ...
      <section>
        ...
        <div className="grid lg:grid-cols-2 lg:gap-6">
          <div className="flex flex-col rounded-xl border border-neutral-800/60 bg-neutral-900/30 p-6">
            <h3 className="title-3">What I learned</h3>
            ...
            <ul className="list list-disc list-inside">
              ...
              <li>
                It's not enough to communicate effectively, you have to
                communicate <em>efficiently</em>. With only 23 hours until the
                project was due, every second mattered.
              </li>
            </ul>
          </div>
        </div>
