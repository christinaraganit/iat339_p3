...
export default function MobileNav() {
  return (
    <div className="sm:hidden fixed top-6 w-56 right-6 text-right">
      <Menu
        as="div"
      ...
      >
        <div className="group/menu">
          ...
          group-hover/menu:from-neutral-700/30 group-hover/menu:via-neutral-500 group-hover/menu:to-neutral-700/30
          group-focus/menu:from-neutral-700/30 group-focus/menu:via-neutral-500 group-focus/menu:to-neutral-700/30 transition-colors
          "
          >
            <Menu.Button className="inline-flex w-full justify-center rounded-lg bg-neutral-800 group-hover/menu:bg-neutral-800/60 transition-colors px-4 py-2 text-sm font-medium text-neutral-200">
              Menu
              <ChevronDownIcon
                className="-mr-1 ml-2 h-5 w-5 text-neutral-200 group-hover/menu:animate-bounce transition-transform"
                aria-hidden="true"
              />
            </Menu.Button>
          </div>
